...
```{r, echo=FALSE, fig.align='center', fig.cap='DB Browser for SQLite graphical user interface.'}
knitr::include_graphics("data/SQL/screenshot.png")
```
...
```{r model, echo=FALSE, fig.align='center', fig.cap='Employee logical database model.'}
knitr::include_graphics("data/SQL/model.png")
```
