...
````
`r paste(readLines('./data/R_reproducibility_examples/rmarkdown_example.Rmd'), collapse = '\n')`
````
...
````
`r paste(readLines('./data/R_reproducibility_examples/rnotebook_example.Rmd'), collapse = '\n')`
````
...
````
`r paste(readLines('./data/R_reproducibility_examples/sweave_example.Rnw'), collapse = '\n')`
````
