...
```{r, echo=FALSE, fig.align='center', fig.cap='Relation representation.'}
knitr::include_graphics("data/SQL/relation.png")
```
...
```{r, echo=FALSE, fig.align='center', fig.cap='Order of SQL query execution.'}
knitr::include_graphics("data/SQL/SQL_execution_order.png")
```
